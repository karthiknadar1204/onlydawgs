...
// Resend email functionality is commented out, but left for future use
// import { Resend } from "resend";
// import WelcomeEmail from "@/emails/WelcomeEmail";
// import ReceiptEmail from "@/emails/ReceiptEmail";
        ...
        if (customerDetails.email) {
          ...
          for (const item of lineItems) {
            ...
            if (isSubscription) {
              ...
              // One-time payment logic (commented out for now)
              // Implement one-time payment logic here if needed
            }
          }
        }
        break;
      }
      // Other cases are commented out but left for future implementation
      // case "customer.subscription.deleted":
      // case "checkout.session.expired":
      default:
        console.warn(`Unhandled event type: ${eventType}`);
